...
func main() {
	...
	listen := flag.String("listen", envOr("IPXE_LISTEN", ":8080"), "HTTP listen address")
	publicURL := flag.String("public-url", envOr("IPXE_PUBLIC_URL", ""), "public URL advertised to iPXE clients (e.g. http://192.168.1.10:8080)")
